...
# Initial designing
Before I even CADde anything I made quite a few sketches on my ipad. 

![Overall rocket sections that will be worked on individually](https://res.cloudinary.com/dfj6fqqc3/image/upload/v1777838487/Untitled_Artwork_39_cx69cz.png)

![TVC mechanism sketch](https://res.cloudinary.com/dfj6fqqc3/image/upload/v1777838503/Untitled_Artwork-1_rnawqu.png)

![TVC mechanism refined sketch](https://res.cloudinary.com/dfj6fqqc3/image/upload/v1777838488/IMG_0534_yl0vdx.png)
...
![Master sketch](https://res.cloudinary.com/dfj6fqqc3/image/upload/v1777838481/master-sketch_jygezk.png)
...
![First servo mount sketch](https://res.cloudinary.com/dfj6fqqc3/image/upload/v1777838491/IMG_0535_udzqbo.png)

![First servo mount CAD](https://res.cloudinary.com/dfj6fqqc3/image/upload/v1777838481/servo-mount-V1_gfn7gj.png)

I made another copy and I was quite happy with it all except for the space utilisation. 

![Second servo mount CAD](https://res.cloudinary.com/dfj6fqqc3/image/upload/v1777838482/servo-mount-v2_fni2jk.png)
...
![Third servo mount sketch](https://res.cloudinary.com/dfj6fqqc3/image/upload/v1777838507/IMG_0538_vdqmhx.png)


![Third servo mount CAD](https://res.cloudinary.com/dfj6fqqc3/image/upload/v1777838485/servo-mount-V3_qr0vee.png)

![Third servo mount top sketch to show servo motor layout](https://res.cloudinary.com/dfj6fqqc3/image/upload/v1777838497/servo-mount-V3-top_j0tcdk.png)

![Third servo mount side sketch to show servo motor layout](https://res.cloudinary.com/dfj6fqqc3/image/upload/v1777838483/servo-mount-V3-side_aykvt3.png)

Currently, I am struggling a lot with the motor mount and have gone back and forth with a lot of designs. The big issue is manufacturing. 3D printing is not suitable due to the heat from the motor, not even ABS, and the shapes I need are so irregular that it is difficult to make with services like sendcutsend, which only does flat sheet metal and bending. Furthermore, attaching the gimbal would be incredibly difficult because of the weird thread size (15/16-27) as it’s a faucet standard and not a standard anywhere else. (I purchases a 360 degree swivel aerator to use as the gimbal, which uses universal faucet threads). 

![Here is my idea for the mount overall](https://res.cloudinary.com/dfj6fqqc3/image/upload/v1777838492/IMG_0536_jd20sx.png)
...
![First motor mount sketch](https://res.cloudinary.com/dfj6fqqc3/image/upload/v1777838500/IMG_0537_dez8io.png)

![First motor mount CAD](https://res.cloudinary.com/dfj6fqqc3/image/upload/v1777838493/motor-mount-old_ftcsat.png)
...
![Second motor mount sketch](https://res.cloudinary.com/dfj6fqqc3/image/upload/v1777838511/IMG_0539_lafz15.png)

![Second motor mount CAD](https://res.cloudinary.com/dfj6fqqc3/image/upload/v1777838483/motor-mount-old2_emzzsb.png)
...
![Third motor mount sketch](https://res.cloudinary.com/dfj6fqqc3/image/upload/v1777838503/IMG_0540_nbltve.png)

![Third motor mount CAD](https://res.cloudinary.com/dfj6fqqc3/image/upload/v1777838482/motor-mount-V3_kgpzvk.png)
